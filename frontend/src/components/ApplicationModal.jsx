    ...
    <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.7)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:200, padding:'1rem' }}>
      <div className="card animate-fade" style={{ width:'100%', maxWidth:500, padding:'2rem' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'1.5rem' }}>
          <h2 style={{ fontSize:'1.25rem' }}>Apply to "{project.title}"</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom:'1.25rem' }}>
            ...
            <textarea className="input-field" placeholder="Tell the project owner about your skills, experience, and what you can contribute..." value={message} onChange={(e) => setMessage(e.target.value)} rows={5} />
          </div>
